...
"[project]/app/api/professorApi.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function registerProfessor(payload) {
    const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/api/professors/register`, {
        method: "POST",
        headers: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$professorApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/api/professorApi.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function Register() {
    ...
    const verifyOtp = async (e)=>{
        ...
        try {
            ...
            // 2️⃣ REGISTER PROFESSOR USING COMMON API
            const { ok, data: regData } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$professorApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["registerProfessor"])({
                name: form.name,
            ...
            if (ok) {
                ...
                alert(regData.message || "Registration failed at backend");
            }
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__db3903e6._.js.map