...
"[project]/app/api/studentApi.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function registerStudent(payload) {
    const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/api/students/register`, {
        method: "POST",
        headers: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$studentApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/api/studentApi.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function StudentRegister() {
    ...
    const verifyOtp = async (e)=>{
        ...
        try {
            ...
            //   return;
            // }
            // 2️⃣ CALL BACKEND STUDENT REGISTRATION API
            const { ok, data: regData } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$studentApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["registerStudent"])({
                name: form.name,
                email: form.email,
            ...
            if (ok) {
                ...
                alert(regData.message || "Student registration failed");
            }
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e12d8d63._.js.map