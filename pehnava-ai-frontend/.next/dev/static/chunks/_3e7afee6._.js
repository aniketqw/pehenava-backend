...
"[project]/app/api/studentApi.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function registerStudent(payload) {
    const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/api/students/register`, {
        method: "POST",
        headers: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$studentApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/api/studentApi.ts [app-client] (ecmascript)");
;
...
function StudentRegister() {
    ...
    const verifyOtp = async (e)=>{
        ...
        try {
            ...
            const { ok, data: regData } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$studentApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["registerStudent"])({
                name: form.name,
                email: form.email,
...
_s(StudentRegister, "gGSi4w4E9Mfn0Ddh0uQc2QL+I+w=", false, function() {
    return [
...
//# sourceMappingURL=_3e7afee6._.js.map