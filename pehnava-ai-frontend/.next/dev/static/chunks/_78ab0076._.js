...
"[project]/app/api/professorApi.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function registerProfessor(payload) {
    const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/api/professors/register`, {
        method: "POST",
        headers: {
...
"[project]/app/professor/register/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$professorApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/api/professorApi.ts [app-client] (ecmascript)");
;
...
function Register() {
    ...
    const verifyOtp = async (e)=>{
        ...
        try {
            ...
            const { ok, data: regData } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$professorApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["registerProfessor"])({
                name: form.name,
...
_s(Register, "QhKXVQDvic1GJ1Zd2LcasQwL3Ds=", false, function() {
    return [
...
//# sourceMappingURL=_78ab0076._.js.map